                ...
                @if(isset($order) && $order->count())
                        ...
                        <div class="col-lg-4 col-md-4">
                            <form action="/backend/change-order-status-courier" id="status" method="post">
                                ...
                                <select class="form-control status-select"  name="status" id="status_selected">
                                    @php $statuses = Arr::except(config('api.courier_order.status'), array('status_300','status_301', 'status_302','status_304','pending')) @endphp
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4">
                            ...
                            <p>{{!empty($order->carrierRelation) ? $order->carrierRelation->carrier_name : 'N/A'}}</p>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            ...
                            <label class="delivery_label">Envelope</label>
                            <p class="item-display">
                                {{$order->envelope ? $order->envelope: 'N/A'}}
                            </p>
                        </div>
                        </div> <div class="col-lg-4 col-md-4">
