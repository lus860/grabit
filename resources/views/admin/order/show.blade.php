...
{{--                                {{\App\Services\OrderService::getOrderCollectionAmount($order,$order->action)}}--}}
                            </p>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <label class="delivery_label">Discount</label>
                            <p class="item-display">
                                {{!empty($order->discount)?$order->discount: 0}}
                            </p>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <label class="delivery_label">Discounted Price</label>
                            <p class="item-display">
                                {{!empty($order->discounted_price)?$order->discounted_price: 0}}
                            </p>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <form action="/backend/change-order-status" id="status" method="post">
                                ...
                                <select class="form-control status-select"  name="status">
                                    @php $statuses = Arr::except(config('api.order.status'), array('status_300','status_301', 'status_302','status_304','pending')) @endphp
