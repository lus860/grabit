...
@section('body')
    ...
    <form action="{{url('/')}}/backend/admin/add-phone-numbers" enctype="multipart/form-data" method="post">
        @csrf
                    ...
                    @foreach($data as $phone_number)
                        <div class="item-option-container col-md-12">
                            <div class="form-group col-lg-6 col-md-6">
                                <input placeholder="Enter phone number" name="phone[]" value="{{$phone_number}}" type="text" class="form-control" />
                            </div>
                            <div class="form-group col-lg-6 col-md-6">
