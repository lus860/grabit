        ...
        <div class="col-xs-12 col-md-5 " style="border: 1px solid #c8ccd0">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6 text-left">
                    <select name="status" class="order-status-select form-control" id="" @if(!$order->rider_name) disabled @endif>
                        ...
                        @php $statuses = Arr::except(config('api.courier_order.status'), array('waiting', 'dispatch','Cancelled','accepted','pending','status_300')) @endphp
                ...
                <div class="col-xs-12 col-md-6 text-left">
                    <p class="manage-order-body">
                        @if($order->vendor_user)
                            {{$order->vendor_user->restaurant?$order->vendor_user->restaurant->name:'N/A'}}
                        @else
                            {{$order->user->name}}
                        @endif
                    </p>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6 text-left">
                    <p class="manage-order-body">
                        @if($order->vendor_user)
                            {{$order->vendor_user->restaurant->phone?:'N/A'}}
                        @else
                            {{$order->user->phone}}
                        @endif
                    </p>
