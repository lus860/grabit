...
class MainController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.frontend.body', $data);
    }
    ...
    {
        return view('admin.frontend.contacts');
    }
    ...
    public function filter($crud, $parent)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('admin.frontend.filter_view', $data);
        }
    ...
    public function product($slug, $id)
    {
        ...
        return view('admin.frontend.product_page', $data);
    }
    ...
    public function frame($id)
    {
        ...
        return view('admin.frontend.frame', compact('item'));
    }
    ...
    public function welcome()
    {
        ...
        return view('admin.messages.welcome')->with('user', $user);
    }
}
